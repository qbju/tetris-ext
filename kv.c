...
int _start(void){int c,n=0;if(done){finish();return 0;}done=1;out[0]=0;call[4]=0;call[5]=0;while((c=get())>=0&&c!=10&&n<0)call[16+n++]=(u8)c;call[0]=18;call[1]=255;call[2]=(u8)n;return 2;}